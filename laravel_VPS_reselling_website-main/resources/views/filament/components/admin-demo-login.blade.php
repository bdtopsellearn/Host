@if(config('app.demo_login_enabled'))
    ...
    <div class="vortex-demo-box">
        <div class="vortex-demo-header">
            ...
            <span class="vortex-env-badge">Active</span>
        </div>
        <p class="vortex-demo-desc">
            Sign in with your configured Super Admin account or use 1-click instant login:
        </p>
        ...
        <div class="vortex-demo-divider">
            ...
            <span class="vortex-demo-or">or type credentials manually</span>
            <div class="vortex-demo-line"></div>
        </div>
    </div>
@endif
